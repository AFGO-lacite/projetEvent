...
export const metadata = {
  title: "Information",
  description: "Information du site web CarTuningShow.",
  openGraph: {
    title: "Information",
    description: "Information du site web CarTuningShow.",
    images: ["/logo.png"],
    ...
    <div className={styles.div}>
      ...
      <div>
        ...
        <p>
          ...
          par l`&apos;`univers du tuning automobile. Notre site web est conçu
          pour offrir une expérience complète et immersive dans le monde des car
          tuning shows.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          localisation, rendant la recherche d`&apos;`un événement spécifique
      ...
      <div>
        ...
        <p>
          Chaque événement listé sur notre site est accompagné d`&apos;`une
          description détaillée, incluant le type d`&apos;`événement (comme les
          shows, les compétitions ou les meet-ups), les véhicules présentés, et
          les activités spéciales prévues. Cette section est conçue pour aider
          les visiteurs à trouver des événements qui correspondent parfaitement
          à leurs intérêts.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          Une fonctionnalité clé de CarTuningShow est la possibilité
          d`&apos;`acheter des billets directement sur le site. Les utilisateurs
          peuvent sélectionner leurs événements, choisir leurs sièges et
          effectuer des transactions sécurisées, le tout en quelques clics.
        </p>
      </div>
